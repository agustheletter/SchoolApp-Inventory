...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  ...
  <div class="mt-20">
    <a href="/user/barang" class="inline-flex items-center text-blue-600 hover:text-blue-800 transition-colors duration-200">
         <i class="fa-solid fa-arrow-left"></i>Kembali ke Daftar Barang
    </a>
  </div>
